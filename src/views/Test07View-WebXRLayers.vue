    ...
    <div class="container">
      <div class="render-cont-outer">
        <div class="container">
          <div class="row">
            <div class="col">
              <h1>Test 7 - WebXR Layers</h1>
              Test of WebXR layers.
            </div>
          </div>
          <div class="row">
            <div class="col">
...
import { Scene007WebXrLayers } from '../js/scenes/Scene007-WebXRLayers'

useTitle('Test 7 - WebXR Layers | Kaliatech')
...
function init() {
  ...
  appManager.init().then(() => {
    if (appManager) {
      appManager.loadScene(new Scene007WebXrLayers(appManager))
    }
  })
}
